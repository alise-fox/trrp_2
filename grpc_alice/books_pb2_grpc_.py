...
def add_BookTransferServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'books.BookTransfer', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('books.BookTransfer', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class BookTransfer(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def SendBook(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            books__pb2.BookReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
